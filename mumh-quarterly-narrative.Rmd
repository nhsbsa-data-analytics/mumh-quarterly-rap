...
# England April 2016 to `r max_filter_12_months` {.toc-ignore}
...
This publication presents data from April 2016 to `r max_filter_12_months`, the most recent available.
...
`r covpar_0402` This small increase in prescribed items is in line with the expected range of values for the period.
...
`r covpar_0404` This increase in prescribed items does not fall outside of the expected range of values for the overall period. However, beginning in August 2021 and including all three months of quarter 3 2021/22, there have been four consecutive months above the number of items expected based on historical trends.  
...
The number of items for each BNF section in the 22-month period March 2020 to `r max_filter_12_months` were compared to the number of items expected to be prescribed based on trends from the 'pre-COVID-19' period. The monthly data for April 2015 to February 2020 was used to extrapolate expected figures for March 2020 to `r max_filter_12_months`. These figures were extrapolated according to:
