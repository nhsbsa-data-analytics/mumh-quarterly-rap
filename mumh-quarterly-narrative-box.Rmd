...
:::
:::{.col-md-4}
`r mumhquarterly::infoBox_no_border("", text = "This box blank for a COVID key finding?", width = "100%")`
:::
::::
...
::::{.row style="display: flex;"}
:::{.col-md-4}
`r infoBox_no_border(header = "Changes to these statistics", text = "this is a larger box with more text to test the height stay the same. this is a larger box with more text to test the height stay the same", width = "100%")`
:::
:::{.col-md-4}
`r infoBox_no_border("This is box 2", text = "this text goes in the middle", width = "100%")`
:::
:::{.col-md-4}
`r infoBox_no_border("This is box 2", text = "this text goes in the middle", width = "100%")`
:::
