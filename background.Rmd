...
The final model was also tested using smaller 5 year age bands. This increased the number of age band levels used, and therefore the number of possible combinations with gender. Although the model using 5 year age bands had a lower AIC, this model was not selected because of evidence of overfitting. Overfitting occurs when adding many variables into a model improves the fit of the model on its training data, but makes the model less generalisable to new data. Ten year age bands were used instead to reduce both the overall complexity of the model and the risk of overfitting. The model was kept relatively simplistic overall, to stay consistent with the model used in previous releases across the financial year.
